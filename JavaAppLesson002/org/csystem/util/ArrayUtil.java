...
public final class ArrayUtil {
    ...
    public static boolean isEmpty(int [] a) {return a.length == 0;}
    public static boolean isNotEmpty(int [] a) {return !isEmpty(a);}

    public static boolean isEmpty(double [] a) {return a.length == 0;}
    public static boolean isNotEmpty(double [] a) {return !isEmpty(a);}
